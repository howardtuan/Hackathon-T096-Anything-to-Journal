...
<p align="center"><a href="https://hackathon-t096-anything-to-journal-website.howardtuan.workers.dev/">Website</a> · <a href="README.zh-TW.md">繁體中文</a> · <a href="README.md">Hackathon submission</a></p>
...
```text
Please install this Agent Skill for me: https://github.com/howardtuan/Hackathon-T096-Anything-to-Journal
```
...
- a TeX engine: Tectonic is preferred, with `latexmk`, XeLaTeX, or pdfLaTeX supported;
